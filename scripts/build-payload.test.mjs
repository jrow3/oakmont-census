...
test('buildBlockSection derives 55+/85+/tenure from summed DHC values', () => {
  const v = {
    ...
    P12_001N: 5000,
    P12_017N: 30, P12_041N: 30,                     // some 55-59 (in 55+, not 65+)
  ...
  assert.equal(s.snapshot.pct55Plus, 8);            // 400 / 5000 * 100
